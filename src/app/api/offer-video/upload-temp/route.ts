...
// نفس حسابات Cloudinary المستخدمة في فيديو الهيرو — بنعيد استخدامها هنا
// (الرفع مؤقت بس، مفيش داعي لحساب مخصص للعروض)
...
export async function POST(req: NextRequest) {
  try {
    ...
    // رفع مؤقت — من غير حذف بعد كده (بيتحذف بعد finalize)
